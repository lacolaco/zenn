...
このOverlayを使ったことがある開発者なら一度はぶつかったことのある壁として、オーバーレイに表示したコンポーネントが閉じるときにどうやってアニメーションするかである。たとえば、ユーザーになにかのメッセージを一定時間だけ表示してフェードアウトする、いわゆるトーストメッセージというやつを作ってみよう。
